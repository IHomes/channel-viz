(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'gQpGimXKH7C9gbDy5fJ4RRrmLOnkFJxsxYveGvjAWiL3zNlD', // Unique master Xively API key to be used as a default
		defaultFeeds	= [531502134], // Comma separated array of Xively Feed ID numbers
		applicationName	= 'IHomes Demo', // Replaces Xively logo in the header
		dataDuration	= '', // Default duration of data to be displayed // ref: https://xively.com/dev/docs/api/data/read/historical_data/
		dataInterval	= 60, // Default interval for data to be displayed (in seconds)
		dataColor		= 'F5', // CSS HEX value of color to represent data (omit leading #)
